 ...
 * It is recursive and efficient for large data sets.
 * It does log(n) merge steps, runs in O(n*log(n))
 * 
 * Step:
 * 1. separate the array in to two arrays at middle index
 * 2. repeat step 1, until every array only have one item
 * 3. sort and merge every two arrays
 * 4. repeat step 3, until it becomes an array again
 * @author Alfred
 *
 */
